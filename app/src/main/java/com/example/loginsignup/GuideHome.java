...
ProgressDialog progressDialog;
   ...
   FirebaseFirestore db=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earn=findViewById(R.id.button2);
        noti=findViewById(R.id.button3);
...
//     Log.d("dname2","After calling");
        ...
        earn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(GuideHome.this,GuideEarnings.class);
        ...
        profilepic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              ImagePicker.with(GuideHome.this).cropSquare().compress(512).maxResultSize(512,512)
        ...
        db.collection("guidesInfo").document("Ss7rBllzexFPWBakyEW5")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(GuideHome.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        storageReference.putFile(selectedImageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(GuideHome.this,"SuccessFully Uploaded",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(GuideHome.this, "Failed to Upload", Toast.LENGTH_SHORT).show();
                    }
                });
